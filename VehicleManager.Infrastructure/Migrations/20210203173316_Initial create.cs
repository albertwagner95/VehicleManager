    ...
    public partial class Initialcreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuelForRefuelings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_KindfOfEvents", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitOfFuels", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "VehicleBrandNames",
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VehicleBrandNames", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedDateTime = table.Column<DateTime>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false),
                    AmountOfFuel = table.Column<decimal>(nullable: false),
                    FuelPrice = table.Column<decimal>(nullable: false),
                    PriceForOneUnit = table.Column<decimal>(nullable: false),
                    MeterStatus = table.Column<int>(nullable: false),
                    PetrolStationName = table.Column<string>(nullable: true),
                    IsRefulingFull = table.Column<bool>(nullable: false),
                    Varnings = table.Column<string>(nullable: true),
                    VehicleId = table.Column<int>(nullable: false),
                    BurningFuelPerOneHundredKilometers = table.Column<decimal>(nullable: false),
                    UnitOfFuelId = table.Column<int>(nullable: false),
                    FuelForRefuelingId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_KindfOfEvents_EventListId",
                        column: x => x.EventListId,
                        principalTable: "KindfOfEvents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_FuelForRefuelings_FuelForRefuelingId",
                        column: x => x.FuelForRefuelingId,
                        principalTable: "FuelForRefuelings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Events_UnitOfFuels_UnitOfFuelId",
                        column: x => x.UnitOfFuelId,
                        principalTable: "UnitOfFuels",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGasInstalation = table.Column<bool>(nullable: false),
                    ApplicationUserID = table.Column<string>(nullable: true),
                    VehicleBrandNameId = table.Column<int>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Vehicles_VehicleBrandNames_VehicleBrandNameId",
                        column: x => x.VehicleBrandNameId,
                        principalTable: "VehicleBrandNames",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Vehicles_VehicleFuelTypes_VehicleFuelTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    EventRef = table.Column<string>(nullable: true),
                    VehicleId = table.Column<int>(nullable: false),
                    ApplicationUserID = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarHistories_Events_EventRef",
                        column: x => x.EventRef,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CarHistories_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarHistories_EventRef",
                table: "CarHistories",
                column: "EventRef",
                unique: true,
                filter: "[EventRef] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_CarHistories_VehicleId",
                table: "CarHistories",
                column: "VehicleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_FuelForRefuelingId",
                table: "Events",
                column: "FuelForRefuelingId");

            migrationBuilder.CreateIndex(
                name: "IX_Events_UnitOfFuelId",
                table: "Events",
                column: "UnitOfFuelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_VehicleBrandNameId",
                table: "Vehicles",
                column: "VehicleBrandNameId");

            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_VehicleFuelTypeId",
                table: "Vehicles",
