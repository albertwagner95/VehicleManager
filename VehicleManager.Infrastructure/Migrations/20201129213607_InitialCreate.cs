    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Refulings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Refulings_FuelForRefuelings_FuelForRefuelingId",
                        column: x => x.FuelForRefuelingId,
                        principalTable: "FuelForRefuelings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Refulings_UnitOfFuels_UnitOfFuelId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsActive = table.Column<bool>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    RefulingRef = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarHistories_Refulings_RefulingRef",
                        column: x => x.RefulingRef,
                        principalTable: "Refulings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CarHistories_RefulingRef",
                table: "CarHistories",
                column: "RefulingRef",
                unique: true,
                filter: "[RefulingRef] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Refulings_FuelForRefuelingId",
                table: "Refulings",
                column: "FuelForRefuelingId");

            migrationBuilder.CreateIndex(
                name: "IX_Refulings_UnitOfFuelId",
                table: "Refulings",
                column: "UnitOfFuelId");
